...
ALTER TABLE TEMPORADA ADD CONSTRAINT PK_TEMPORADA PRIMARY KEY (AÑO);
...
ALTER TABLE PARTIDO ADD CONSTRAINT PK_PARTIDO PRIMARY KEY(FECHA);
...
ALTER TABLE GOL ADD CONSTRAINT PK_GOL PRIMARY KEY (MIN);
