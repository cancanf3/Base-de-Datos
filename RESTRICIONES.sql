...
FOREIGN KEY (J_TEMPORADA,TC_NOMBRE) REFERENCES TEMPORADA(AÑO, C_NOMBRE);
...
PRIMARY KEY (NACIONALIDAD, FIFA_ID);
...
ALTER TABLE AMONESTA ADD CONSTRAINT PK_AMONESTA 
PRIMARY KEY (A_ARBITRO, A_PARTIDO, LOCAL, VISITANTE);
...
FOREIGN KEY (A_PARTIDO, LOCAL, VISITANTE) 
REFERENCES PARTIDO(FECHA, LOCAL, VISITANTE);
...
PRIMARY KEY (MIN, EN_PARTIDO, LOCAL, VISITANTE);
...
FOREIGN KEY (EN_PARTIDO, LOCAL, VISITANTE) 
REFERENCES PARTIDO(FECHA, LOCAL, VISITANTE);
...
ALTER TABLE SE_ANOTA ADD CONSTRAINT PK_SE_ANOTA
PRIMARY KEY (A_PARTIDO, A_MIN, P_LOCAL, P_VISITANTE);
ALTER TABLE SE_ANOTA ADD CONSTRAINT FK_SE_ANOTA_PARTIDO
FOREIGN KEY (A_PARTIDO, P_LOCAL, P_VISITANTE) 
REFERENCES PARTIDO(FECHA, LOCAL, VISITANTE);
ALTER TABLE SE_ANOTA ADD CONSTRAINT FK_SE_ANOTA_GOL
FOREIGN KEY (A_MIN, A_PARTIDO, G_LOCAL, G_VISITANTE) 
REFERENCES GOL(MIN, EN_PARTIDO, LOCAL, VISITANTE);


/* RESTRICCIONES DE CONVOCADO */
ALTER TABLE CONVOCADO ADD CONSTRAINT PK_CONVOCADO 
PRIMARY KEY	(C_JUGADOR, C_PARTIDO, LOCAL, VISITANTE);
...
FOREIGN KEY	(C_PARTIDO, LOCAL, VISITANTE) 
REFERENCES PARTIDO(FECHA, LOCAL, VISITANTE);
...
ALTER TABLE PERTENECE_A_LA ADD CONSTRAINT PK_PERTENECE
PRIMARY KEY (C_NOMBRE, PARTIDO, LOCAL, VISITANTE);
...
FOREIGN KEY (PARTIDO, LOCAL, VISITANTE) 
REFERENCES PARTIDO(FECHA, LOCAL, VISITANTE);
...
ALTER TABLE COMPITE_EN ADD CONSTRAINT PK_COMPITE
PRIMARY KEY (C_NOMBRE, E_NOMBRE);
