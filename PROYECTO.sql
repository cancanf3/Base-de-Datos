...
CREATE TABLE TEMPORADA (
	AÑO					INTEGER CONSTRAINT PK_TEMPORADA PRIMARY KEY,
...
CREATE TABLE PARTIDO (
	...
	ASISTENCIA			INTEGER CONSTRAINT DOM_PARTIDO_ASISTENCIA 
								CHECK (ASISTENCIA >= 0),
	MARCADOR			POINT,
	DURACION			INTEGER CONSTRAINT DOM_PARTIDO_DURACION 
								CHECK (DURACION > 0),
	...
	CONSTRAINT  EXP_PARTIDO CHECK (LOCAL != VISITANTE)
);
...
CREATE TABLE JUGADOR(
	...
	ESTATURA			REAL CONSTRAINT DOM_JUGADOR_ESTATURA CHECK (ESTATURA > 0),
	PESO				REAL CONSTRAINT DOM_JUGADOR_PESO CHECK (ESTATURA >0),
	CJ_EQUIPO			VARCHAR(40) CONSTRAINT FK_JUGADOR_EQUIPO
									REFERENCES EQUIPO,
...
CREATE TABLE AMONESTA (
	MIN 				NUMERIC(2,0) CONSTRAINT DOM_AMONESTA_MIN CHECK (MIN >0),
	AMARILLA			BOOLEAN,
	ROJA				BOOLEAN,
	...
	A_ARBITRO			INTEGER CONSTRAINT FK_AMONESTA_ARBITRO
							  	REFERENCES ARBITRO,
	CONSTRAINT EXP_AMONESTA CHECK (AMARILLA != ROJA)
);
...
CREATE TABLE GOL(
	...
	EN_PARTIDO 			DATE CONSTRAINT FK_GOL_PARTIDO
								  REFERENCES PARTIDO,
	ASISTE				BOOLEAN CONSTRAINT FK_GOL_JUGADOR
								REFERENCES JUGADOR,
	ANOTA 				BOOLEAN	CONSTRAINT FK_GOL_JUGADOR01
								REFERENCES JUGADOR,
...
CREATE TABLE PERTENECE_A_LA (
	...
	PARTIDO 			DATE CONSTRAINT FK_PERTENECE_PARTIDO
								REFERENCES PARTIDO,
	JORNADA				INTEGER CONSTRAINT DOM_PERTENECE_JORNADA CHECK (JORNADA > 0),
